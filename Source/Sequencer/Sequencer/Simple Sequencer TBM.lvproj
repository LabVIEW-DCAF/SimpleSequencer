...
<Project Type="Project" LVVersion="14008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="sequencer parent classes" Type="Folder">
			<Item Name="action configuration.lvclass" Type="LVClass" URL="../sequencer parent classes/action configuration parent/action configuration.lvclass"/>
			<Item Name="action.lvclass" Type="LVClass" URL="../sequencer parent classes/action parent/action.lvclass"/>
			<Item Name="base TBM sequencer configuration.lvclass" Type="LVClass" URL="../sequencer parent classes/sequencer config parent/base TBM sequencer configuration.lvclass"/>
		</Item>
		<Item Name="Simple Sequencer TBM configuration.lvclass" Type="LVClass" URL="../module/configuration/Simple Sequencer TBM configuration.lvclass"/>
		<Item Name="Simple Sequencer TBM runtime.lvclass" Type="LVClass" URL="../module/execution/Simple Sequencer TBM runtime.lvclass"/>
		<Item Name="Simple Sequencer TBM editor node.lvclass" Type="LVClass" URL="../editor node/Simple Sequencer TBM editor node.lvclass"/>
		<Item Name="Simple Sequencer API.lvclass" Type="LVClass" URL="../simple sequencer api/Simple Sequencer API.lvclass"/>
		<Item Name="Sequencer Documentation.docx" Type="Document" URL="../Sequencer Documentation.docx"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="initialize debug mode.vi" Type="VI" URL="../editor node/initialize debug mode.vi"/>
